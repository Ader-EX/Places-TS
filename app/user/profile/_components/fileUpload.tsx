  ...
  (
    ...
    return (
      <div className={className}>
        {lablText && (
          <label
            className="block text-gray-600 text-xs lg:text-sm xl:text-base mb-2 self-center"
            htmlFor="txt"
          >
            {lablText}
          </label>
        ...
        <label
          className={
            " w-full  relative border flex  rounded-md cursor-pointer  group self-center"
          }
        >
          <div
          ...
          <span className="mx-2 self-center">{fileName}</span>
        </label>
        {error && (
